...
'  
  ...
  for(i in 1:length(jdata_Items)) {
    ...
    if(altskala[c(i),]==2){
      Test=select(jdata,levels2)
      Leveldescription= select(jdata,leveldescription2)
    }
    
    if(altskala[c(i),]==3){
      Test=select(jdata,levels3)
      Leveldescription= select(jdata,leveldescription3)
    }
    
    if(altskala[c(i),]==4){
      Test=select(jdata,levels4)
      Leveldescription= select(jdata,leveldescription4)
    }
